...
export function TrustBar() {
  ...
  return (
    <section className="bg-background px-4 py-14 sm:px-6 lg:px-8">
      ...
      >
        {trustItems.map((item) => (
          <div key={item.titleKey} className="rounded-2xl border border-white/70 bg-white/75 p-5 shadow-sm backdrop-blur-md">
            ...
            <h3 className="mt-4 text-base font-black text-foreground">{t(item.titleKey)}</h3>
